...
@RestController
@RequestMapping(value = "/consulDiscovery")
public class ConsulDiscoveryController {
	...
	public String getbills()
	{
		...
		URI uri = discoverClient.getInstances("c")
		.stream()
		.map(si -> si.getUri()).findFirst()
				.map(s -> s.resolve("/provider/get")).get();
